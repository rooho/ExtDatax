...
public class CommonRdbmsWriter {
    ...
    public static class Task {
        ...
        public void init(Configuration writerSliceConfig) {
            ...
            duplicateKeys = writerSliceConfig.getList(Key.DUPLICATE_KEYS, String.class);
...
//                    break;
        ...
        private void calcWriteRecordSql() {
            if (!VALUE_HOLDER.equals(calcValueHolder(""))) {
                ...
                INSERT_OR_REPLACE_TEMPLATE = WriterUtil.getWriteTemplate(columns, valueHolders, writeMode, duplicateKeys, dataBaseType, forceUseUpdate);
