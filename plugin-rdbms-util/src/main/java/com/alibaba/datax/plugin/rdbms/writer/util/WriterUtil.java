...
public final class WriterUtil {
    ...
    public static String getWriteTemplate(List<String> columnHolders, List<String> valueHolders, String writeMode, List<String> duplicateKeys, DataBaseType dataBaseType, boolean forceUseUpdate) {
        ...
        if (forceUseUpdate ||
            ...
            writeDataSqlTemplate = new StringBuilder()
                    ...
                    .append(")")
                    .append(onDuplicateKeyUpdateString(duplicateKeys, columnHolders))
                    .toString();
        } else {
    ...
    public static String onDuplicateKeyUpdateString(List<String> duplicateKeys, List<String> columnHolders){
        if (columnHolders == null || columnHolders.size() < 1) {
            return "";
        }
        StringBuilder sb = new StringBuilder();
        sb.append(" ON DUPLICATE KEY UPDATE ");
        columnHolders.forEach(column-> {
            if (duplicateKeys.contains(column)){
                return;
            }
            sb.append(column);
            sb.append("=VALUES(");
